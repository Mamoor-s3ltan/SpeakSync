  ...
  const [scheduledMeetings, setScheduledMeetings] = useState([
    {
      ...
      time: "14:00",
      status: "Upcoming",
      link: `${window.location.origin}/meeting/abc123`,
    },
    {
      id: 2,
      title: "Client Call",
      ...
      time: "10:00",
      status: "Upcoming",
      link: `${window.location.origin}/meeting/def456`,
    },
  ]);
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-2xl sm:text-3xl font-bold text-black mb-6 sm:mb-8">Schedule Meeting</h1>

        {/* Create Meeting Form or Success UI */}
          ...
          <div className="bg-green-50 rounded-xl p-6 sm:p-8 mb-6 sm:mb-8 shadow-sm border border-green-200">
            ...
            <div className="bg-white rounded-lg p-4 mb-6">
              ...
              <div className="flex gap-2">
                ...
                />
                <button
                  onClick={() => copyLink(createdMeeting.link)}
